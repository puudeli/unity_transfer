...
class PoseConverter:
    def __init__(self):
        ...
        rospy.loginfo("Initialised pose_converter")
    ...
    def unity_poses_cb(self, msg: TrackedPoses): 
        ...
        left_ee_pose.pose.orientation.x = - msg.lcon_rot_z
        left_ee_pose.pose.orientation.y = msg.lcon_rot_x
        left_ee_pose.pose.orientation.z = - msg.lcon_rot_y
        ...
        right_ee_pose.pose.orientation.x = - msg.rcon_rot_z
        right_ee_pose.pose.orientation.y = msg.rcon_rot_x
        right_ee_pose.pose.orientation.z = - msg.rcon_rot_y
        ...
        head_pose.pose.orientation.x = - msg.hs_rot_z
        head_pose.pose.orientation.y = msg.hs_rot_x
        head_pose.pose.orientation.z = - msg.hs_rot_y
